  ...
  return (
    <div>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontSize: 22, fontWeight: 800, letterSpacing: -0.5 }}>{title}</h2>
            ...
            {loading ? (
              ...
              orders.map((o) => (
                <tr key={o._id}>
                  ...
                  <td>
                    <span
                      className={`admin-badge ${o.paymentStatus === "PAID" ? "admin-badge-delivered" : "admin-badge-pending"}`}
                    >
                      {o.paymentStatus === "PAID" ? "Paid" : "Unpaid"}
                    </span>
                    {o.isBilled && (
                      <span style={{ display: "block", fontSize: 10, marginTop: 4, color: "var(--admin-text-dim)" }}>
                        Bill sent
                      </span>
                    )}
                  </td>
                  ...
                  <td>
                    <div style={{ display: "flex", flexDirection: "column", gap: 6, minWidth: 140 }}>
                      ...
                      <select
                        ...
                        style={{ height: 32, fontSize: 11, padding: "0 28px 0 8px" }}
                        value={o.status}
                      ...
                      {orderType === "part" && !o.courierTracking && (
                        <button
                          type="button"
                          className="admin-btn admin-btn-ghost admin-btn-sm"
                          onClick={() => setTrackingModal(o._id)}
                        >
                          Add tracking
                        </button>
                      )}
        ...
        {totalPages > 1 && (
          <div className="admin-pagination">
            ...
            <div className="admin-pagination-btns">
              <button type="button" className="admin-pagination-btn" disabled={page <= 1} onClick={() => setPage(page - 1)}>
                ‹
              </button>
        ...
        <div className="admin-modal-overlay" onClick={() => setTrackingModal(null)}>
          <div className="admin-modal" onClick={(e) => e.stopPropagation()}>
            <div className="admin-modal-header">
              ...
              <button type="button" className="admin-btn admin-btn-ghost admin-btn-sm" onClick={() => setTrackingModal(null)}>
            ...
            <div className="admin-modal-footer">
              <button type="button" className="admin-btn admin-btn-secondary" onClick={() => setTrackingModal(null)}>
                Cancel
              </button>
              <button type="button" className="admin-btn admin-btn-primary" onClick={handleTrackingSubmit}>
